...
-- Objetivo: Vincular duración de viajes con clima para prueba de hipótesis 
...
WHERE
    ...
    AND EXTRACT(DOW FROM t.start_ts) = 6 -- Filtramos por viajes que comenzaron en Loop (ID 50) y terminaron en O'Hare (ID 63) un sábado (DOW 6)
ORDER BY
    t.trip_id;